...
//
//     final branchDetailResponse = branchDetailResponseFromJson(jsonString);

import 'dart:convert';

List<BranchDetailResponse> branchDetailResponseFromJson(String str) => List<BranchDetailResponse>.from(json.decode(str).map((x) => BranchDetailResponse.fromJson(x)));

String branchDetailResponseToJson(List<BranchDetailResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class BranchDetailResponse {
  ...
  factory BranchDetailResponse.fromJson(Map<String, dynamic> json) => BranchDetailResponse(
