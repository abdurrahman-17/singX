...
//
//     final getProfileValues = getProfileValuesFromJson(jsonString);

import 'dart:convert';

GetProfileValues getProfileValuesFromJson(String str) => GetProfileValues.fromJson(json.decode(str));

String getProfileValuesToJson(GetProfileValues data) => json.encode(data.toJson());

class GetProfileValues {
  GetProfileValues({
    this.tittle,
    this.firstName,
    this.middleName,
  ...
  factory GetProfileValues.fromJson(Map<String, dynamic> json) => GetProfileValues(
